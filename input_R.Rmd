...
<h3>Import Data</h3>
<h4>Copy and paste data with scan()</h4>
...
<h4>Auto import with read.csv()</h4>
...
library(readxl)
(ben.data2 <- read_excel("lengthdata.xlsx")) #Same as ben.data
#View the names of the sheets in an excel file
excel_sheets("lengthdata.xlsx")
```
